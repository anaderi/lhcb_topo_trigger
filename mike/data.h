...
// Wed Aug 20 09:19:14 2014 by ROOT version 5.34/05
// from TTree data/data
// found on file: Hlt.MC15.MD.30000000.0.140818.00.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Double_t        l0_mu2_pt;
   Double_t        l0_dmu_pt;
   vector<double>  *hlt1_trk0_pt;
   vector<double>  *hlt1_trk0_p;
   ...
   TBranch        *b_l0_mu2_pt;   //!
   TBranch        *b_l0_dmu_pt;   //!
   TBranch        *b_hlt1_trk0_pt;   //!
   TBranch        *b_hlt1_trk0_p;   //!
...
// used to generate this class and read the Tree.
  /*
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Hlt.MC15.MD.30000000.0.140818.00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Hlt.MC15.MD.30000000.0.140818.00.root");
      }
...
void data::Init(TTree *tree)
{
   ...
   //   fChain->SetBranchAddress("hlt1_trk0_pt", &hlt1_trk0_pt, &b_hlt1_trk0_pt);
   //fChain->SetBranchAddress("hlt1_trk0_p", &hlt1_trk0_p, &b_hlt1_trk0_p);
